...
(define-primitive-table kernel-table
  ...
  [compare-hash-code (known-procedure/single-valued 2)]
  ...
  [partial-compare (known-procedure/single-valued 4)]
  [partial-compare/recur (known-procedure/single-valued 8)]
  ...
  [prop:partial-order (known-struct-type-property/immediate-guard)]
