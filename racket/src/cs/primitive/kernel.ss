...
(define-primitive-table kernel-table
  ...
  [current-code-inspector (known-procedure/single-valued 3)]
  [current-command-line-arguments (known-procedure/single-valued 3)]
  [current-compile-target-machine (known-procedure/single-valued 3)]
  [current-continuation-marks (known-procedure/single-valued 3)]
  [current-custodian (known-procedure/single-valued 3)]
  [current-directory (known-procedure/single-valued 3)]
  [current-directory-for-user (known-procedure/single-valued 3)]
  [current-drive (known-procedure/no-prompt 1)]
  [current-environment-variables (known-procedure/single-valued 3)]
  [current-error-port (known-procedure/single-valued 3)]
  ...
  [current-load-relative-directory (known-procedure/single-valued 3)]
  [current-locale (known-procedure/single-valued 3)]
  [current-logger (known-procedure/single-valued 3)]
  [current-memory-use (known-procedure/no-prompt 3)]
  [current-milliseconds (known-procedure/no-prompt 1)]
  [current-output-port (known-procedure/single-valued 3)]
  [current-plumber (known-procedure/single-valued 3)]
  [current-preserved-thread-cell-values (known-procedure/no-prompt 3)]
  [current-print (known-procedure/single-valued 3)]
  [current-process-milliseconds (known-procedure/no-prompt 3)]
  [current-prompt-read (known-procedure/single-valued 3)]
  [current-pseudo-random-generator (known-procedure/single-valued 3)]
  [current-read-interaction (known-procedure/single-valued 3)]
  ...
  [current-write-relative-directory (known-procedure/single-valued 3)]
  ...
  [make-struct-field-accessor (known-procedure/single-valued 12)]
  ...
  [procedure-reduce-arity (known-procedure/single-valued 12)]
  [procedure-reduce-arity-mask (known-procedure/single-valued 12)]
  [procedure-rename (known-procedure/single-valued 4)]
