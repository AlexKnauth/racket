  ...
  @item{The two-procedure case supports customization of @racket[equal-always?],
       ...
       @itemlist[
         @item{@racket[_equal-proc : (any/c any/c (any/c any/c . -> . boolean?)  boolean? . -> . any/c)]
               ...
               is @racket[#t] for an @racket[equal?] or @racket[impersonator-of?] comparison,
               or @racket[#f] for an @racket[equal-always?] or @racket[chaperone-of?] comparison.
               Any result except @racket[#f] indicates that the given two values
